...
Ajax has become so popular that you hardly find an application that doesn't 
use Ajax 
to some extent. 
...
// Jquery is javascript liabraries $.ajax()
...
// jquery load function which load page data direct withaout loading
/*
$(document).ready(function(){
  $("button").click(function(){
    $(".test").load("data.php");
